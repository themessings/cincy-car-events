...
class CollectorTests(unittest.TestCase):
    ...
    def test_normalize_location_for_output_handles_split_street_name(self):
        raw = "8540 Gander Creek Dr Miamisburg, OH 45342 United States"
        out = normalize_location_for_output(raw, "Miamisburg, OH")
        self.assertEqual(out, "8540 Gander Creek Dr, Miamisburg OH 45342")

    def test_get_location_normalizer_returns_callable(self):
        fn = get_location_normalizer()
        self.assertTrue(callable(fn))
        self.assertEqual(fn("2812 Fishinger Rd, Upper Arlington, OH 43220", "Upper Arlington, OH"), "2812 Fishinger Rd, Upper Arlington OH 43220")
